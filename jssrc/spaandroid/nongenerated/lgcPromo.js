...
function getListPromo() {
    ...
    getAdd.invokeOperation("indukPromo", headers, data, operationSuccess, operationFailure);
...
function getPromoDetail() {
    ...
    getAdd.invokeOperation("detailInduk", headers, data, operationSuccess, operationFailure);
    ...
    function operationSuccess(response) {
        if (response.opstatus === 0) {
            ...
            for (var i = 0; i < response.message.newsPromoImage.length; i++) {
                var tempdata = {
                    newsPromoImage: response.message.newsPromoImage[i]
                };
...
function getAnakPromo() {
    ...
    getAdd.invokeOperation("listPromo", headers, data, operationSuccess, operationFailure);
...
function getAnakPromoDetail() {
    ...
    getAdd.invokeOperation("detailListPromo", headers, data, operationSuccess, operationFailure);
    ...
    function operationSuccess(response) {
        if (response.opstatus === 0) {
            ...
            for (var i = 0; i < response.listNewsPromoCdn.length; i++) {
                var tempdata = {
                    newsPromoImage: response.listNewsPromoCdn[i]
                };
                dataImg.push(tempdata);
            }
