function addWidgetsfrmDetailNews() {
    ...
    var flxShare2 = new kony.ui.FlexContainer({
        "autogrowMode": kony.flex.AUTOGROW_NONE,
        "clipBounds": true,
        "height": "40%",
        "id": "flxShare2",
    ...
    flxShare2.setDefaultUnit(kony.flex.DP);
    var flxCopyLink = new kony.ui.FlexContainer({
        "autogrowMode": kony.flex.AUTOGROW_NONE,
        "centerY": "50%",
        "clipBounds": true,
        "height": "75%",
    ...
    flxCopyLink.setDefaultUnit(kony.flex.DP);
    var CopyimgFb0g56e8d03df5641 = new kony.ui.Image2({
        "height": "100%",
        "id": "CopyimgFb0g56e8d03df5641",
        "isVisible": true,
        "left": 0,
        "skin": "slImage",
        "src": "group.png",
    ...
    flxCopyLink.add(CopyimgFb0g56e8d03df5641);
    flxShare2.add(flxCopyLink);
    flxRectShare.add(imgRectShare, flxShare1, flxShare2);
