...
function callbackHandlerChartAll() {
    ...
    if (this.readyState == constants.HTTP_READY_STATE_DONE) {
        ...
        if (lastArah !== false) {
            ...
            flxNewsEvent.imgCompas.animate(kony.ui.createAnimation({
                "100": {
                    "stepConfig": {
        ...
        if (lastArah2 !== false) {
            ...
            flxNewsEvent.imgCompas2.animate(kony.ui.createAnimation({
                "100": {
                    "stepConfig": {
                        "timingFunction": kony.anim.EASE
                    },
        ...
        if (lastArah3 !== false) {
            ...
            flxNewsEvent.imgCompas3.animate(kony.ui.createAnimation({
                "100": {
                    "stepConfig": {
                        "timingFunction": kony.anim.EASE
                    },
...
function callbackHandlerChartAllPage() {
    ...
    if (this.readyState == constants.HTTP_READY_STATE_DONE) {
        ...
        if (lastArah !== false) {
            var trans100 = kony.ui.makeAffineTransform();
            trans100.rotate(lastArah);
            frmPantauPage.imgCompas.animate(kony.ui.createAnimation({
                "100": {
                    "stepConfig": {
                        "timingFunction": kony.anim.EASE
                    },
        ...
        if (lastArah2 !== false) {
            var trans1002 = kony.ui.makeAffineTransform();
            trans1002.rotate(lastArah2);
            frmPantauPage.imgCompas2.animate(kony.ui.createAnimation({
                "100": {
                    "stepConfig": {
                        "timingFunction": kony.anim.EASE
                    },
        ...
        if (lastArah3 !== false) {
            var trans1003 = kony.ui.makeAffineTransform();
            trans1003.rotate(lastArah3);
            frmPantauPage.imgCompas3.animate(kony.ui.createAnimation({
                "100": {
                    "stepConfig": {
                        "timingFunction": kony.anim.EASE
                    },
