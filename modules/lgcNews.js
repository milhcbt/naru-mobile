...
function getNewsAsd(){
  ...
  getAdd.invokeOperation("news", headers, data, operationSuccess, 
                         operationFailure);
...
function getCharityEvent(){
  ...
  getAdd.invokeOperation("charity", headers, data, operationSuccess, 
                         operationFailure);
...
function getDetailCharity(){
  ...
  if(obj[0]!==null){
    ...
    frmDetailNews.sgmImage.addAll([{imgNews:newsImg}]);
  }
}
...
function getCharityTelkom(){
  ...
  getAdd.invokeOperation("charitiTelkom", headers, data, operationSuccess, 
                         operationFailure);
