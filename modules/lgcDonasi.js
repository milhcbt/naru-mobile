...
function inisiasiForm(){
  frmDonasi.txtJumlahDonasi.text=null;
  frmDonasi.txtPonsel.text=null;
  frmDonasi.txtNama.text=null;
  frmDonasi.txtAlamat.text=null;
}
...
function getListInstansi(){
  ...
  getAdd.invokeOperation("instansi", headers, data, operationSuccess, 
                         operationFailure);
...
function gestureBrowserCC(){ 
  frmDonasi.flxBrowserCC.animate(
