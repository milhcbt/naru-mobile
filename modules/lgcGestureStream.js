...
function geserBrowserPage(){
	frmPantauPage.flxDummyBrowser.setGestureRecognizer(2, {fingers: 1}, gestureFunc);  
  	frmPantauPage.flxDummy2.setGestureRecognizer(2, {fingers: 1}, gestureFunc);  
}

function geserBrowser(){
	flxNewsEvent.flxDummyBrowser.setGestureRecognizer(2, {fingers: 1}, gestureFuncHome);  
  	flxNewsEvent.flxDummy2.setGestureRecognizer(2, {fingers: 1}, gestureFuncHome);    
}
...
function swipeGestureLeftPage(){ 
  ...
  frmPantauPage.browser2.animate(
    kony.ui.createAnimation({
        "100": {
            "left": "0%",
            "stepConfig": {
