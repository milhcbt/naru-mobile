...
function gestureOpenShare(){ 
  ...
  frmDetailNews.flxRectShare.animate(
...
function gestureOpenShareDetailpromo(){ 
  ...
  frmDetailPromo.flxRectShare.animate(
    kony.ui.createAnimation({
        "100": {
            "top": "6%",
            "stepConfig": {
...
function gestureOpenShareSukarelawan(){ 
  ...
  frmSukarelawan.flxRectShare.animate(
    kony.ui.createAnimation({
        "100": {
            "top": "6%",
            "stepConfig": {
...
function gestureOpenShareDonasi(){ 
  ...
  frmDonasi.flxRectShare.animate(
    kony.ui.createAnimation({
        "100": {
            "top": "6%",
            "stepConfig": {
